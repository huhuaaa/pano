...
# 多线程
def createCubeFront(file, width, height, sample):
    sphere = UnitSphere()
    sphere.LoadTexture('pano1.jpg')
    print('generating front face')
    face = GetCubeFrontRect()
...
def createCubeLeft(file, width, height, sample):
    sphere = UnitSphere()
    sphere.LoadTexture('pano1.jpg')
    print('generating right face')
    face = GetCubeLeftRect()
...
def createCubeRight(file, width, height, sample):
    sphere = UnitSphere()
    sphere.LoadTexture('pano1.jpg')
    print('generating left face')
    face = GetCubeRightRect()
...
def createCubeBack(file, width, height, sample):
    sphere = UnitSphere()
    sphere.LoadTexture('pano1.jpg')
    print('generating back face')
    face = GetCubeBackRect()
...
def createCubeTop(file, width, height, sample):
    sphere = UnitSphere()
    sphere.LoadTexture('pano1.jpg')
    print('generating top face')
    face = GetCubeTopRect()
...
def createCubeBottom(file, width, height, sample):
    sphere = UnitSphere()
    sphere.LoadTexture('pano1.jpg')
    print('generating bottom face')
    face = GetCubeBottomRect()
...
# python多线程目前没有能完全利用多核cpu
# def run_threading(w, h, s):
#     # input unit cube and sphere
#     # work on each cube face
#     sphere = UnitSphere()
#     sphere.LoadTexture('pano1.jpg')
...
#     threads = []
#     # front face
#     threads.append(threading.Thread(target=createCubeFront, args=(sphere, 'f.jpg', w, h, s)))

#     # right face
#     threads.append(threading.Thread(target=createCubeRight, args=(sphere, 'r.jpg', w, h, s)))

#     # left face
#     threads.append(threading.Thread(target=createCubeLeft, args=(sphere, 'l.jpg', w, h, s)))

#     # back face
#     threads.append(threading.Thread(target=createCubeBack, args=(sphere, 'b.jpg', w, h, s)))

#     # top face
#     threads.append(threading.Thread(target=createCubeTop, args=(sphere, 'u.jpg', w, h, s)))

#     # bottom face
#     threads.append(threading.Thread(target=createCubeBottom, args=(sphere, 'd.jpg', w, h, s)))
...
#             print('run end')
#         # else:
#             # print('running: ' + str(isAliveCount))
#         time.sleep(1)

#     return

def run_process(w, h, s):
    # input unit cube and sphere
    # work on each cube face
    # sphere = UnitSphere()
    # sphere.LoadTexture('pano1.jpg')
    ...
    processes = []
    # front face
    processes.append(multiprocessing.Process(target=createCubeFront, args=('f.jpg', w, h, s)))

    # right face
    processes.append(multiprocessing.Process(target=createCubeRight, args=('r.jpg', w, h, s)))

    # left face
    processes.append(multiprocessing.Process(target=createCubeLeft, args=('l.jpg', w, h, s)))

    # back face
    processes.append(multiprocessing.Process(target=createCubeBack, args=('b.jpg', w, h, s)))

    # top face
    processes.append(multiprocessing.Process(target=createCubeTop, args=('u.jpg', w, h, s)))

    # bottom face
    processes.append(multiprocessing.Process(target=createCubeBottom, args=('d.jpg', w, h, s)))
...
if __name__ == '__main__':
    # run_test(1500, 1500, 1)
    # run_threading(1500, 1500, 1)
    run_process(1500, 1500, 1)